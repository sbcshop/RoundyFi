...
2. Now choose board from tool -> board -> ESP8266 boards - > NodeMCU 1.0 ( ESP-12E Module), then compile and run the "wifi_weather_display.ino" example.
...
3. Install ArduinoJson library from "include library->manage library->write 'ArduinoJson' and search, then download the latest version
